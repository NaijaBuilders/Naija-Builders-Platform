                    ...
                    <tr>
                        <td style="padding:32px 28px 12px;">
                            ...
                            <p style="margin:0; color:#5A6B85; font-size:14px; line-height:22px;">
                                ...
                                use the code below to confirm your email address on NaijaBuilders.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding:4px 28px 28px;">
                            ...
                            <p style="margin:0; color:#5A6B85; font-size:13px; line-height:20px;">
                                If you did not request this code, you can safely ignore this email &mdash; your account is not at risk.
                            </p>
                        </td>
                    </tr>
                    <tr>
