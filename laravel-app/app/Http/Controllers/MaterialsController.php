...
class MaterialsController extends Controller
{
    ...
    public function rateProduct(Request $request)
    {
        ...
        $material = DB::table('materials')
            ...
            ->where('id', (int) $validated['material_id'])
            ->where('status', 'active')
            ->first();
        ...
        return back()->with('save_success', 'Your product rating has been saved.');
    }
    ...
    public function rateSupplier(Request $request)
    {
        ...
        return back()->with('save_success', 'Your supplier rating has been saved.');
    }
}
